...
const change_country = document.querySelector(".change-country")
const close_list_btn = document.querySelector(".close")
const input = document.getElementById('search-input')

function createCountry () {
const number_countries = country_list.length;
let i = 0, ul_list_id;

country_list.forEach( (country, index) => {

if(index % Math.ceil(number_countries/num_of_ul_lists) == 0){
    ul_list_id = `list-${i}`;
